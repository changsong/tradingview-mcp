...
## 添加Wathlist
使用 ./scripts/launch_tv_debug.bat 启动TradigView，将 001257,002050,002080,002156,002185,002371,002384,002409,002428,002463,002472,002527,002617,002741,002896,002916,002938,002975,000021,000636,000977,300054,300285,300308,300394,300408,300475,300476,300502,300537,300706,301200,301217,301308,600110,600176,600183,600206,600378,600460,600487,600522,600584,600703,600707,601138,601208,601689,601869,601958,603019,603186,603228,603256,603283,603290,603595 这些股票加入 A股可交易 这个watchlist

使用 ./scripts/launch_tv_debug.bat 启动TradigView，将 LLY, AVGO, MU, CRWD, NOW, GEV, NBIS, ISRG, BE, CRCL, RKLB, TEM, KTOS, IONQ  这些股票加入 美股可交易 这个watchlist

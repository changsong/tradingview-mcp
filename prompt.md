...
## 添加Wathlist
使用 ./scripts/launch_tv_debug.bat 启动TradigView，将 603629,300442,300857,000977,300752,601138,603019,002837,301018,002536,002938,300476,002916,002463,600183,002384,688256,688041,002230,601360,300033,300308,300502,300394,002281,688498,600406,600089,000400,002028,601126,688676,300274,300763,300750,688390,688063,300014,000063,600487,600522,300620,600519,000858,600809,000568,000596,000799,601899,603993,600362,603799,600549,002466,300750,002460,002074,688818,300014,300750,002594,300014,002466,002460,002074,688981,002371,688012,688256,688041,600584 这些股票加入 A股可交易 这个watchlist

使用 ./scripts/launch_tv_debug.bat 启动TradigView，将 SMCI,DOCN,EQIX,DLR,IRM,VRT,SBGSY,HON,MMM,TTMI,JBL,SANM,FLEX,CLS,PLXS,NVDA,MSFT,GOOGL,AMD,META,AI,AVGO,MRVL,LITE,COHR,GLW,ETN,GEV,SMNEY,HUBB,GNRC,NEE,SO,DUK,ENPH,RUN,FSLR,CSCO,CIEN,ERIC,NOK,VIAV,FCX,SCCO,RIO,ALB,SQM,WPM,QS,SLDP,ENVX,SES,MU,QCOM,ADI,TSLA,LAR,SGML,ENS 这些股票加入 美股可交易 这个watchlist

使用 ./scripts/launch_tv_debug.bat 启动TradigView，将 09698,01686,03896,01396,00992,00700,09988,00200,00981,01347,00563,09888,00522,01072,01133,02380,00836,02688,00916,00941,00763,00552,00291,00322,02899,03993,00661,01208,01772,09696,02465,03750,01211 这些股票加入 港股可交易 这个watchlist

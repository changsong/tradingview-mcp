...
## 添加Wathlist
使用 ./scripts/launch_tv_debug.bat 启动TradigView，将 300274,605117,300763,688390,688032,688508,300827,601567,002843,301658,688348,600089,601179,000400,002028,688676,600550,002922,603191,301120,300444,002885,300040,300953 这些股票加入 A股可交易 这个watchlist

使用 ./scripts/launch_tv_debug.bat 启动TradigView，将 ENPH,SEDG,GNRC,TYGO,SBGSY,SMERY,SMTGY,GEV,ETN,HTHIY,ABBNY,HMDPF,PWR 这些股票加入 美股可交易 这个watchlist

使用 ./scripts/launch_tv_debug.bat 启动TradigView，将 06656,03393,08070,02722,01072,01608,02727,01133,00658,02208,00042,002028,002270,002922,300763,300274,605117 这些股票加入 港股可交易 这个watchlist

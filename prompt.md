...
## 评估体系优化
先在需要分析一个原因：今天是5月6日，昨日的股票分析结果在 ./reports/2026-05-05 
...
### 使用 ./scripts/launch_tv_debug.bat 启动TradigView，请使用策略名为：A Share SQZMOM PRO v11 (Daily)， 请分析这个策略，有没有可以提高的地方, 先列出可能优化的点，并制定优化计划，
在日线上进行回测并分析交易清单，对策略进行改进，提高交易量同时提高胜率，提高收益,优化策略后，请使用 ../watchlist/cn.txt 做回测，根据回测结果持续优化，直到不能持续优化为止

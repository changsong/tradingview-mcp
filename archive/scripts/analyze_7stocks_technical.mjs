...
const V11 = {
  ...
  'SZSE:002489': { trendUp:false, validComp:true,  volMom:true,  fakeBreak:false },
  'SSE:603103':  { trendUp:false, validComp:true,  volMom:true,  fakeBreak:false },
  'SSE:600662':  { trendUp:false, validComp:true,  volMom:false, fakeBreak:false },
  'SZSE:002811': { trendUp:false, validComp:true,  volMom:true,  fakeBreak:false },
  'SZSE:002920': { trendUp:false, validComp:true,  volMom:true,  fakeBreak:false },
  'SZSE:300383': { trendUp:true,  validComp:false, volMom:false, fakeBreak:false },
};

const NAMES = {
  'SSE:605599':'菜百股份','SZSE:002489':'浙江永强','SSE:603103':'横店影视',
  'SSE:600662':'外服控股','SZSE:002811':'郑中设计','SZSE:002920':'德赛西威','SZSE:300383':'光环新网',
};
...
async function main() {
  ...
  // 保存
  const out = `technical_analysis_7stocks_${new Date().toISOString().slice(0,10)}.json`;
